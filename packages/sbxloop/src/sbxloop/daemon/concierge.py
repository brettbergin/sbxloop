            ...
            HostTool(
                HostToolSpec(
                    ...
                    description=(
                        ...
                        "cancel [--retry] | queue | move <item> before|after <item> | "
                        "items | abandon <item> [reason] | "
                        "campaigns [name] | campaign start <name> <item>... | "
                        "campaign hold <name> [reason] | campaign resume <name> | "
                        "campaign move <name> <item> before|after <item> | "
                        ...
                        "move changes pending queue order without preempting a run or "
                        "bypassing retry backoff; queue shows positions and resumes first. "
                        "campaign start groups explicitly named queued items into a serial "
                        "procedure; each successful delivery releases the next step. "
                        "campaigns explains progress and blockers. A campaign hold parks "
                        "that procedure while other work may continue; resume releases "
                        "the hold without treating a failed step as successful. "
            ...
            HostTool(
                HostToolSpec(
                    ...
                    description=(
                        ...
                        "report, a data pull, a document, a check against a service — on "
                        "any subject, whether or not it concerns sbxloop or a repository. "
                        "One call, no confirmation: never ask whether to queue it. "
                        "`profile` names a `[[workloads]]` profile "
