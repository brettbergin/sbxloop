...
from sdxloop_worker.protocol import EventTypes
...
# `sdxloop logs`): streaming deltas, raw stdout passthrough, heartbeats.
_TRANSCRIPT_SKIP = {
...
def format_event(event: Event) -> str:
    """Dense single-line form (used by `sdxloop logs` and lifecycle lines)."""
