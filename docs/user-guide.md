...
repositories. The usual queue limits,
...
| `[entrygraph] enabled`                                                         | `true`                                          | Whether the concierge offers `start_entrygraph`, the fixed repository-analysis workload. False removes the tool from its roster entirely.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
