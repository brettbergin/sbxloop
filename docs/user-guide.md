...
| `[[vcs.repos]] repo`                                                                                                       | none                                                                                                                                                                                                                | A repository sbxloop works with, one entry each, whatever forge it lives on (#2255); with none declared the forge is off and a run stops after its gate. Each entry carries its own `enabled`, `kind`, `workspace`, delivery settings, labels, token variable and sandbox overrides; the `[daemon]` guardrails stay daemon-wide. `[[github.repos]]` is the legacy spelling and still loads as this list.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
