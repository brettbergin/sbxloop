...
| `[concierge] max_concurrent_turns`                                                                 | `1`                                                                                                              | How many chat turns may run at once (1 to 16). Each turn keeps its own speaker, session and interrupted-call recovery, so turns in different channels cannot read each other's; host tools still run one at a time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
