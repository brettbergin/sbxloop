...
# renders github-runner.service with this host's runner directory and home,
# enables it and takes the linger; never copy the template by hand, a later
# init rewrites its rendered copy
sbxloop init --systemd --no-sbx --runner ~/actions-runner
